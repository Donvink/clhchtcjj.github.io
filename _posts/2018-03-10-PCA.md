...
设有$q$个因变量{${\bf{y}}_1,{\bf{y}}_2,...,{\bf{y}}_q$}和$p$个自变量{${\bf{x}}_1,{\bf{x}}_2,...,{\bf{x}}_p$}。为了研究这两组变量的统计关系，我们观测了$n$个样本点，由此构成了两个数据矩阵$X=[x_1,x2,...,x_p]_{n\times p}$和$Y=[y_1,y_2,...,y_q]_{n\times q}$。偏最小二乘回归分别在$X$和$Y$中提取成分${\bf{u}}_1$和${\bf{v}}_1$（${\bf{u}}_1$和${\bf{v}}_1$分别是${\bf{x}}_1,{\bf{x}}_2,...,{\bf{x}}_p$和${\bf{y}}_1,{\bf{y}}_2,...,{\bf{y}}_q$的线性组合）。在提取这两个成分时，为了回归分析的需要，有下面两个要求：
